...
int __pthread_create(pthread_t *restrict res, const pthread_attr_t *restrict attrp, void *(*entry)(void *), void *restrict arg)
{
	...
	a_inc(&libc.threads_minus_1);
  	...
  	unsigned long params[7];
  	params[0] = (unsigned long)(c11 ? start_c11 : start);
  	params[1] = (unsigned long)stack;
  	params[2] = (unsigned long)flags;
  	params[3] = (unsigned long)new;
  	params[4] = (unsigned long)&new->tid;
  	params[5] = (unsigned long)TP_ADJ(new);
  	params[6] = (unsigned long)&new->tid;

	ret = __syscall1(SYS_clone, params);
