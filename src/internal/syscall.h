...
#ifdef SYS_open
#define __sys_open2(x,pn,fl) (int)__syscall3(SYS_open, pn, (fl)|O_LARGEFILE, 0)
#define __sys_open3(x,pn,fl,mo) (int)__syscall3(SYS_open, pn, (fl)|O_LARGEFILE, mo)
#define __sys_open_cp2(x,pn,fl) __sys_open2(SYS_open, pn, (fl)|O_LARGEFILE)
#define __sys_open_cp3(x,pn,fl,mo) __sys_open3(SYS_open, pn, (fl)|O_LARGEFILE, mo)
#else
